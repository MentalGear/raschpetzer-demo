...
const c = {
	...
	sectionsPhotoP5P4: {
		id: 'c-gallery-p5-p4-photo',
		title: 'The Raschpëtzer — A Roman Underground Water Supply System (p. 25, fig. 5-18 — gallery walls between P5 and P4)',
		authors: 'Faber, Sonja; Waringo, Guy; Werner, Henri',
		year: 2018,
		publisher: "Syndicat d'initiative et de tourisme de la Commune de Walferdange",
	...
	routeDiagram: {
		id: 'c-gallery-route-diagram',
		title: 'The Raschpëtzer — A Roman Underground Water Supply System (p. 26, fig. 5-20 — the gallery route from P3 to the eastern end)',
		authors: 'Faber, Sonja; Waringo, Guy; Werner, Henri',
		year: 2018,
		publisher: "Syndicat d'initiative et de tourisme de la Commune de Walferdange",
		url: `${BROCHURE_PDF}#page=26`,
...
export const galleryArticle: Article = {
	...
	blocks: [
		...
		{
			id: 'gal-sections-photos',
			type: 'gallery',
			items: [
				{
					id: 'gi-p5-p4-walls',
					alt: 'Two cavers in a wide, low gallery passage; the visible wall is made of fissured, pitted limestone blocks with marl debris fallen at their base',
					caption:
						'Between P5 and P4 the gallery walls consist of limestone, with marl debris accumulated at the base of the walls — the "wide" profile of this leg noted in the table above.',
					credit: 'Photo Jérôme Konen (brochure fig. 5-18, p. 25 — matched to this scan by visual content; a folder-wide audit found this corpus’s plain `FigN-NN.jpg` source scans are shuffled relative to the brochure’s own figure numbers, unlike the separately-reviewed `JeKo_*`-prefixed scans such as this one)',
					tone: 3,
					ratio: 3600 / 2400,
					src: asset('/img/raschpetzer/Fig5-18-fallback.jpg'),
					srcset: srcsetOf([
						['/img/raschpetzer/Fig5-18-480w.webp', '480w'],
						['/img/raschpetzer/Fig5-18-960w.webp', '960w'],
						['/img/raschpetzer/Fig5-18-1920w.webp', '1920w'],
					]),
				},
				{
					id: 'gi-route-diagram',
					alt: 'A long schematic plan diagram tracing the gallery route from shaft P3 through P4, P5, P6, P7, P8, to P9, marking "Kanalanfang" (channel start) and a nearby spring',
					caption:
						'The route of the gallery from P3 to the eastern end of the qanat: the misalignment between P3 and P4 was caused by a rockfall, and several orientation errors and corrections between P4 and P9 are evident.',
					credit: 'Photo Jérôme Konen (brochure fig. 5-20, p. 26 — matched to this scan by visual content, not filename; this scan carries German diagram labels not translated here)',
					tone: 1,
					ratio: 9182 / 990,
					src: asset('/img/raschpetzer/Fig5-20-fallback.jpg'),
					srcset: srcsetOf([
						['/img/raschpetzer/Fig5-20-480w.webp', '480w'],
						['/img/raschpetzer/Fig5-20-960w.webp', '960w'],
						['/img/raschpetzer/Fig5-20-1920w.webp', '1920w'],
					]),
				},
			],
		},
